...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'home-hero': "url('/clarity-path/stock1.avif')",
        'home-hero-mob': "url('/clarity-path/stock1mob.avif')",
        'home-hero-blur': "url('/clarity-path/stock1blur.avif')",
        'talk-therapy': "url('/clarity-path/stock6.avif')",
        'diagnostic': "url('/clarity-path/stock2blur.avif')",
        'therapeutic': "url('/clarity-path/stock3blur.avif')",
        'achievement': "url('/clarity-path/stock8blur.avif')",
      },
      animation: {
