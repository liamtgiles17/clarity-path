                    ...
                    <div className="max-md:py-8 md:py-12 align-center">
                        ...
                        <div className="w-full h-full">
                            <div className="md:px-[10%] max-md:px-[5%]">
                                <div className="bg-cover sm:hidden" style={{backgroundImage: `linear-gradient(to right, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 1) 30%, rgba(231, 231, 231, 0.3) 70%, rgba(231, 231, 231, 0.3) 80%, rgba(231, 231, 231, 1) 100%), linear-gradient(to bottom, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 0) 15%, rgba(231, 231, 231, 0) 85%, rgba(231, 231, 231, 1) 100%), url(/stock6small${isExtraSmall ? "2" : ""}.avif)`}}>
                                ...
                                <div className="bg-cover max-sm:hidden" style={{backgroundImage: "linear-gradient(to right, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 1) 30%, rgba(231, 231, 231, 0.3) 70%, rgba(231, 231, 231, 0.3) 80%, rgba(231, 231, 231, 1) 100%), linear-gradient(to bottom, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 0) 15%, rgba(231, 231, 231, 0) 85%, rgba(231, 231, 231, 1) 100%), url(/stock6big.avif)"}}>
                            ...
                            <Tabs variant="fullWidth" theme={tabsTheme}>
                                <Tabs.Item active title="Diagnostic">
                                    <div className="bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 max-w-[110vw]">
                                        <Image className="w-full h-full rounded-lg border-[2px] border-indigo-300" src="/stock2.avif" alt="diagnostic" width={100} height={100}></Image>
                                        <div className="pt-2">
                                ...
                                <Tabs.Item active title="Therapeutic">
                                    <div className="bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 max-w-[110vw]">
                                        <Image className="w-full h-full rounded-lg border-[2px] border-indigo-300" src="/stock3.avif" alt="therapeutic" width={100} height={100}></Image>
                                        <div className="pt-2">
                                ...
                                <Tabs.Item active title="Achievement">
                                    <div className="bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 max-w-[110vw]">
                                        <Image className="w-full h-full rounded-lg border-[2px] border-indigo-300" src="/stock8.avif" alt="achievement" width={100} height={100}></Image>
                                        <div className="pt-2">
                            ...
                            <Tabs variant="underline" theme={tabsTheme}>
                                <Tabs.Item active title="Diagnostic">
                                    <div className="grid grid-cols-2 gap-x-8 bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 items-center">
                                        ...
                                        <div className="flex items-center justify-center">
                                            <Image className="w-full max-w-[36rem] h-auto rounded-lg border-indigo-300 border-[3px]" src="/stock2.avif" alt="diagnostic" width={100} height={100}></Image>
                                        </div>
                                    </div>
                                </Tabs.Item>
                                <Tabs.Item active title="Therapeutic">
                                    <div className="grid grid-cols-2 gap-x-8 bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 items-center">
                                        ...
                                        <div className="flex items-center justify-center">
                                            <Image className="w-full max-w-[36rem] h-auto rounded-lg border-indigo-300 border-[3px]" src="/stock3.avif" alt="therapeutic" width={100} height={100}></Image>
                                        </div>
                                    </div>
                                </Tabs.Item>
                                <Tabs.Item active title="Achievement">
                                    <div className="grid grid-cols-2 gap-x-8 bg-indigo-500 bg-opacity-70 rounded-lg px-2 py-2 items-center">
                                        ...
                                        <div className="flex items-center justify-center">
                                            <Image className="w-full max-w-[36rem] h-auto rounded-lg border-indigo-300 border-[3px]" src="/stock8.avif" alt="achievement" width={100} height={100}></Image>
                                        </div>
                                    </div>
                                </Tabs.Item>
                            </Tabs>
                    ...
                    <div ref={testTrigger} className={testIsInView ? "motion-safe:animate-slideInFromRight md:motion-safe:animate-slideInFromRight2" : "opacity-0"}>
                        ...
                        <div className="h-[36rem] max-sm:hidden">
                            <Carousel indicators={false} theme={carouselTheme} pauseOnHover={true} slideInterval={6000} className="">
                                <div className="bg-cover py-24 md:py-48 xl:py-64 px-2 bg-no-repeat w-full h-full bg-center" style={{backgroundImage: `linear-gradient(to right, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 0.2) 60%, rgba(231, 231, 231, 0.2) 85%, rgba(231, 231, 231, 1) 100%), url(/testimonial1${isExtraLarge ? "large" : ""}.avif)`}}>
                                ...
                                <div className="bg-cover py-24 md:py-48 xl:py-64 px-2 bg-no-repeat w-full h-full" style={{backgroundImage: `linear-gradient(to left, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 0.2) 60%, rgba(231, 231, 231, 0.2) 85%, rgba(231, 231, 231, 1) 100%), url(/testimonial2.avif)`}}>
                                ...
                                <div className="bg-cover py-24 md:py-48 xl:py-64 px-2 bg-no-repeat w-full h-full bg-center" style={{backgroundImage: `linear-gradient(to right, rgba(231, 231, 231, 1) 0%, rgba(231, 231, 231, 0.2) 60%, rgba(231, 231, 231, 0.2) 85%, rgba(231, 231, 231, 1) 100%), url(/testimonial3${isExtraLarge ? "large" : ""}.avif)`}}>
                                    <div className="md:text-lg max-md:text-md xl:text-xl mr-[70%]">
                        ...
                        <div className="h-[32rem] sm:hidden overflow-y-scroll">
                            <Carousel indicators={false} theme={carouselTheme} slide={false} className="">
                                <div className="px-2 py-2 rounded-lg w-full h-full inline-block bg-gray-500">
                                    <Image className="border-[2px] border-gray-400 rounded-lg w-full h-max" src="/testimonial1.avif" alt="testimonial1" width={100} height={100}></Image>
                                ...
                                <div className="px-2 py-2 rounded-lg w-full h-full inline-block bg-gray-500">
                                    <Image className="border-[2px] border-gray-400 rounded-lg w-full h-max" src="/testimonial2.avif" alt="testimonial2" width={100} height={100}></Image>
                                    <div className="text-md text-offwhite pt-2">
                                        <p className="pb-2"><b>This Guy, 29</b></p>
                                        <p><i>&quot;Working with Clarity Path has been a game-changer for me. As an adult with ADHD, I struggled with staying organized and focused, both in my career and personal life. The personalized strategies and support I received have helped me manage my distractions and set achievable goals.&quot;</i></p>
                                    </div>
                                ...
                                <div className="px-2 py-2 rounded-lg w-full h-full inline-block bg-gray-500">
                                    <Image className="border-[2px] border-gray-400 rounded-lg w-full h-max" src="/testimonial3.avif" alt="testimonial3" width={100} height={100}></Image>
                                    <div className="text-md text-offwhite pt-2">
                                        <p className="pb-2"><b>Some One, 32</b></p>
                                        <p><i>&quot;I didn&apos;t realize how much ADHD was affecting my daily life until I found Clarity Path. The practical tools and strategies they&apos;ve provided have helped me improve my time management, reduce overwhelm, and stay focused on what matters most.&quot;</i></p>
                                    </div>
